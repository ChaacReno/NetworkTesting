...
namespace AdvancedSceneManager.Core
{
    ...
    public class CollectionManager : SceneManagerBase
    {
        ...
        [SerializeField] private SceneCollection m_current;
        [SerializeField] private SceneCollection m_previous;
        ...
        public SceneOperation Close() =>
            ...
            : SceneOperation.Add(this).
                ...
                Close(utility.openScenes.Reverse(), force: false).
                Close(openScenes.Where(s => current.Tag(s.scene).closeBehavior == SceneCloseBehavior.KeepOpenIfNextCollectionAlsoContainsScene), force: true).
                WithCallback(Callback.BeforeLoadingScreenClose().Do(() =>
                {
                    m_previous = current;
                    SetNull();
                    ActionUtility.Try(() => closed?.Invoke(previous));
                }));
