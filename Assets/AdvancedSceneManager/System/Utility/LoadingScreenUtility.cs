...
namespace AdvancedSceneManager.Utility
{
    ...
    public static class LoadingScreenUtility
    {
        ...
        public static SceneOperation<LoadingScreen> OpenLoadingScreen(SceneCollection collection, Action<LoadingScreen> callbackBeforeBegin = null)
        {
        ...
        public static SceneOperation<LoadingScreen> OpenLoadingScreen(Scene scene, Action<LoadingScreen> callbackBeforeBegin = null, string typeName = null) =>
            OpenLoadingScreen<LoadingScreen>(scene, callbackBeforeBegin, typeName);

        /// <summary>Shows a loading screen.</summary>
        /// <param name="typeName">Overrides the name of the type in the missing script message.</param>
        public static SceneOperation<T> OpenLoadingScreen<T>(Scene scene, Action<T> callbackBeforeBegin = null, string typeName = null) where T : LoadingScreen
        {
        ...
        const string path = "AdvancedSceneManager/System/Defaults/Fade Loading Screen.unity";
        ...
        public static IEnumerable<LoadingScreen> loadingScreens => m_loadingScreens;
